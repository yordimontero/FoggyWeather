...
object AppConstants {
    ...
    */
    ...
    const val PREFERENCE_LAST_SEARCHED_LOCATION = "LastSearchLocation"
    const val PREFERENCE_WERE_LOCATION_PERMISSION_REQUESTED_SINGLE_TIME = "WereLocationPermissionsRequestedSingleTime"
}